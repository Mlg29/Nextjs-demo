        ...
        <Container>
            <Div>
                <Slider {...settings} ref={sliderRef}>
                    <SliderDiv>
                        ...
                        <Subdiv>
                            <TagDiv>
                                <Paragraph text='Flash sale' textAlign='left' textTransform='uppercase' fontSize={GlobalStyle.size.size25} />
                            </TagDiv>
                            <Paragraph text='Hot sale' textTransform='uppercase' fontSize={GlobalStyle.size.size10} margin='0px 0px 5px 0px' />
                        
                            <RowStart>
                                <Paragraph text={'40%'} textTransform='uppercase' color={GlobalStyle.color.white} fontWeight='bold' fontSize={GlobalStyle.size.size40} margin='0px 5px 2px 0px' />
                                <Paragraph text={'OFF WHEN'} textTransform='uppercase' fontSize={GlobalStyle.size.size40} margin='0px 0px 2px 0px' />
                            </RowStart>
                            <br />
                            <Paragraph text='YOU SHOP WITH US' textTransform='uppercase' fontSize={GlobalStyle.size.size20} />
            ...
            <RowBetween>
                <RowStart>
                    ...
                    <Paragraph text='(All Category)' fontSize={GlobalStyle.size.size12} margin='7px 0px 0px 5px' />
                </RowStart>
            ...
            <Row>
                <Col lg="12">
                    <DownloadDiv>
                        <Subdiv2>
                            <Paragraph text={'DOWNLOAD'} textTransform='uppercase' color={GlobalStyle.color.white} fontWeight='bold' fontSize={GlobalStyle.size.size40} margin='55px 0px 25px 0px' />
                            <Paragraph text={'BAZARA APP'} textTransform='uppercase' color={GlobalStyle.color.white} fontWeight='bold' fontSize={GlobalStyle.size.size40} />
