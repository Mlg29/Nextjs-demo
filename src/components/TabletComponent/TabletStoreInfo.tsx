...
function TabletStoreInfo() {
    ...
    return (
        <Container>
            ...
            <br />
            <Paragraph text='Store items (20)' fontSize={GlobalStyle.size.size24} fontWeight='700' margin='10px 0px 0px 0px' />
            <br />
...
export default TabletStoreInfo
