...
import { RowBetween, RowBetweenStart, RowStart } from '../../utils/StyledComponent'
...
import { cartCheckout, getCarts } from '../../slices/CartSlice'
            ...
            <Row>
                ...
                <Col lg="12">
                    <Div>
                        ...
                        <br/>
                        <RowBetween>
                            <Paragraph text='Total' fontSize={GlobalStyle.size.size10} fontWeight='700' />
