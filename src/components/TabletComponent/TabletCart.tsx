...
import { ColumnCenterGlobal, RowBetween, RowBetweenStart, RowStart } from '../../utils/StyledComponent'
import { GlobalStyle } from '../../utils/themes/themes'
import Paragraph from '../Paragraph'
import CartContainer from '../DesktopComponent/reusable/CartContainer'
    ...
    return (
        <Contain>
            <Row>
                <Col lg="12">
                    <Div>
                        <Paragraph text={`Shopping Cart (${getUserToken ? getCartData?.length : 2} items)`} fontSize={GlobalStyle.size.size24} fontWeight='700' />
                        <br />
                        {
                            ["", ""]?.length > 0 ?
                                <>
