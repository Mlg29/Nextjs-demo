                                    ...
                                    <Dropdown overlay={menu} trigger={['click']}>
                                        <SpaceDiv>
                                            <IconImage
                                                ...
                                                height={20}
                                            />
                                            <Paragraph text={`Hello Olasukanmi`} fontSize={GlobalStyle.size.size16} fontFamily="600" margin='0% 0% 0% 10px ' />
                                        </SpaceDiv>
                                    </Dropdown>
                                </DropdownDiv>
                            </RowStart>
...
export default DesktopBuyerNavigation
