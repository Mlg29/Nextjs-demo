...
import DesktopOrderCard from './reusable/DesktopOrderCard'
    ...
    return (
        <Container>
            ...
            <Row>
                ...
                <Col lg='3'>
                    <div>
                        <Img src='https://res.cloudinary.com/doouwbecx/image/upload/v1660237486/Rectangle_654_ccl1sv.png'  />
                        <Img src='https://res.cloudinary.com/doouwbecx/image/upload/v1660237462/Rectangle_646_cuaaih.png'  />
                    </div>
...
export default DesktopBuyerOrders;
