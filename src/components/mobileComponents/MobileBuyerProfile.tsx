...
import { getPersonalStore, myStore, uploadImage } from '../../slices/StoreSlice'
        ...
        stateLoader ? <ProfileSkeleton />
          ...
          <>
            ...
            <>
                ...
                <Contain>
                  {
                    !imageUrl ? <div className="upload-btn-wrapper">
                      ...
                      <div>
                        ...
                        <ImageContainer type='round' source="https://res.cloudinary.com/doouwbecx/image/upload/v1659633074/1_ktfkhp.png" width={80} height={80} />
                      </div>
                  }
                </Contain>
                <Paragraph text={"Olawale Lawal"} fontSize={GlobalStyle.size.size14} fontWeight="400" margin='0px 0px 0px 5px' />
              </DivContain>
                ...
                edit ?
                  ...
                  <>
                    ...
                    <Box2>
                      ...
                      <Paragraph text={"09827636663"} fontSize={GlobalStyle.size.size15} margin="3px 0px" />
                    </Box2>
                    <Break></Break>
                    <Box2>
                      <Paragraph text='Email' fontSize={GlobalStyle.size.size12} color={GlobalStyle.color.ashes} />
                      <Paragraph text={"kmukhsfg@gmail.com"} fontSize={GlobalStyle.size.size15} margin="3px 0px" />
                    </Box2>
              ...
              <Subdiv>
                <RowBetween>
                  <Paragraph text="Delivery Address" fontSize={GlobalStyle.size.size14} fontWeight="400" />
                </RowBetween>
              ...
              <Div1>
                ...
                <div onClick={() => openVisible()}>
                  <Paragraph text='+  Add delivery Address' fontSize={GlobalStyle.size.size12} color={GlobalStyle.color.bazaraTint} fontWeight='600' />
                </div>
              </Div1>

              <DivBox>
                {
                  myStoreList?.length > 0 && <RowBetween>
                ...
                <div onClick={() => signOut()}>
                  <Paragraph text='Logout' fontSize={GlobalStyle.size.size14} color={GlobalStyle.color.bazaraTint} fontWeight='400' />
                </div>
              </DivBox>
...
export default MobileBuyerProfile
